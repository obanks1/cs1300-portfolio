        ...
        return (
            <div className="developmentdiv">
                ...
                <div className="centered">
                    ...
                    <p className='largePara'>The people we heard from often expressed to us how physically unsafe shelters could be, and that the threat of having any personal belongings stolen was omnipresent. While tents and sleeping bags provide obvious advantages to people, they are often cumbersome yet must be carried everywhere due to the risks leaving them in one place entails. </p>
                    <p className='largePara'>Based on that feedback, we settled on four key aspects of a temporary shelter design: <b>security</b>, <b>privacy</b>, <b>warmth</b>, and <b>portability</b>. Our final design incorporates these four needs in a lockable, folding, weatherproof, lightweight rolling shelter that can be used in tandem with a sleeping bag or warm garment to keep users safe and warm at night.</p>
                    <br/>
                    ...
                    <p className='smallPara smallText'>An existing design for a “shelter in a cart” by designer Yunqin Lee provided inspiration for our lockbox shelter. Lee’s design incorporates an expandable canvas tent that can serve as shelter or storage space and that collapses into a compact rolling cart. Lee’s Cocoon shelter was never actually built or tested, so we adapted and expanded upon some of its characteristics.</p>
